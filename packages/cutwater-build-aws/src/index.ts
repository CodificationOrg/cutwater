...
import { PrepareAWSLambdaImageAssetsTask } from './tasks/PrepareAWSLambdaImageAssetsTask';
...
export const prepareLambdaImageAssetsTask: ExecutableTask<unknown> = new PrepareAWSLambdaImageAssetsTask();
